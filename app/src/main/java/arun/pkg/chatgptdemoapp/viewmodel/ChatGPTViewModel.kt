...
class ChatGPTViewModel @Inject constructor(
    ...
    private var _imageSearchResult: MutableLiveData<String?> = MutableLiveData(null)
    val imageSearchResult: LiveData<String?>
    ...
    fun generateImage(searchText: String) {
        viewModelScope.launch {
            val results = imageGenerationRequest.sendImageGenerationRequest(searchText)
